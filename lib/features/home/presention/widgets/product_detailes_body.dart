...
import 'package:climb_up/features/home/presention/widgets/product_footer.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        ProductFooter(price: price, call: call, supportCallCenterNum: supportCallCenterNum)
      ],
    );
  }
}
